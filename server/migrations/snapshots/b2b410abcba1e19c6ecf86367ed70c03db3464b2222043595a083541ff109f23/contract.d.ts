...
export type FieldOutputTypes = {
  readonly public: {
    readonly Action: {
      ...
      readonly suggestionId: CodecTypes['pg/int4@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    readonly Action: {
      ...
      readonly suggestionId: CodecTypes['pg/int4@1']['input'] | null;
...
export namespace Models {
  export type public_User = {
    ...
    reflectionAnalyses: public_ReflectionAnalysis[];
  ...
  export type public_Goal = {
    ...
    updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    actions: public_Action[];
    suggestions: public_ActionSuggestion[];
    user: public_User;
    readonly [RelationKeys]?: 'actions' | 'suggestions' | 'user';
  };
  export type public_Action = {
    id: CodecTypes['pg/int4@1']['output'];
    userId: CodecTypes['pg/int4@1']['output'];
    goalId: CodecTypes['pg/int4@1']['output'] | null;
    suggestionId: CodecTypes['pg/int4@1']['output'] | null;
    title: CodecTypes['pg/text@1']['output'];
    description: CodecTypes['pg/text@1']['output'] | null;
    status: CodecTypes['pg/text@1']['output'];
    priority: CodecTypes['pg/int4@1']['output'];
    ...
    suggestion: public_ActionSuggestion | null;
    user: public_User;
    readonly [RelationKeys]?: 'goal' | 'suggestion' | 'user';
  };
  ...
  export type public_OAuthAccount = {
    id: CodecTypes['pg/int4@1']['output'];
    userId: CodecTypes['pg/int4@1']['output'];
  ...
  export type public_ActionSuggestion = {
    id: CodecTypes['pg/int4@1']['output'];
    userId: CodecTypes['pg/int4@1']['output'];
    goalId: CodecTypes['pg/int4@1']['output'] | null;
    title: CodecTypes['pg/text@1']['output'];
  ...
  export type public_ReflectionAnalysis = {
    id: CodecTypes['pg/int4@1']['output'];
    reflectionId: CodecTypes['pg/int4@1']['output'];
    userId: CodecTypes['pg/int4@1']['output'];
    summary: CodecTypes['pg/text@1']['output'] | null;
    moodAnalysis: CodecTypes['pg/text@1']['output'] | null;
    productivityAnalysis: CodecTypes['pg/text@1']['output'] | null;
    highlights: CodecTypes['pg/text@1']['output'] | null;
    challenges: CodecTypes['pg/text@1']['output'] | null;
    learnings: CodecTypes['pg/text@1']['output'] | null;
        ...
        readonly entries: {
          readonly table: {
            readonly action: {
              ...
              uniques: readonly [{ readonly columns: readonly ['suggestionId'] }];
              indexes: readonly [
                {
              ...
              foreignKeys: readonly [
                ...
                },
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'action';
                    readonly columns: readonly ['suggestionId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly actionSuggestion: {
              ...
              indexes: readonly [
                {
                  readonly name: 'actionSuggestion_userId_idx_a489d58a';
                  readonly prefix: 'actionSuggestion_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'actionSuggestion_goalId_idx_8733343e';
                  readonly prefix: 'actionSuggestion_goalId_idx';
                  readonly columns: readonly ['goalId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'actionSuggestion_status_idx_e98638ab';
                  readonly prefix: 'actionSuggestion_status_idx';
                  readonly columns: readonly ['status'];
                  readonly unique: false;
                },
                {
            ...
            readonly reflectionAnalysis: {
              columns: {
                ...
                readonly moodAnalysis: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: true;
                };
                readonly productivityAnalysis: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: true;
                };
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['reflectionId'] }];
              indexes: readonly [
                {
                  readonly name: 'reflectionAnalysis_userId_idx_a489d58a';
                  readonly prefix: 'reflectionAnalysis_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'reflectionAnalysis';
                    readonly columns: readonly ['reflectionId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
      ...
      readonly public: {
        readonly models: {
          readonly Action: {
            ...
            readonly relations: {
              ...
              readonly suggestion: {
                ...
                readonly nullable: true;
                readonly on: {
                  readonly localFields: readonly ['suggestionId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly user: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly suggestionId: { readonly column: 'suggestionId' };
          ...
          readonly ActionSuggestion: {
            ...
            readonly relations: {
              readonly action: {
                ...
                readonly on: {
                  ...
                  readonly targetFields: readonly ['suggestionId'];
                };
              };
              readonly goal: {
                readonly to: { readonly namespace: 'public' & NamespaceId; readonly model: 'Goal' };
            ...
            readonly storage: {
              readonly table: 'actionSuggestion';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly userId: { readonly column: 'userId' };
          ...
          readonly ReflectionAnalysis: {
            ...
            readonly storage: {
              readonly table: 'reflectionAnalysis';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly reflectionId: { readonly column: 'reflectionId' };
                readonly userId: { readonly column: 'userId' };
                readonly summary: { readonly column: 'summary' };
                readonly moodAnalysis: { readonly column: 'moodAnalysis' };
                readonly productivityAnalysis: { readonly column: 'productivityAnalysis' };
                readonly highlights: { readonly column: 'highlights' };
                readonly challenges: { readonly column: 'challenges' };
                readonly learnings: { readonly column: 'learnings' };
